...
public class Launcher {
    ...
    public static void main(String[] args) {
        ...
        if(task_type.equalsIgnoreCase("A")) {// Определяем, равны ли переменные s1 и A, игнорируя регистр
            ...
            int key = sc1.nextInt();
            if (language.equalsIgnoreCase("R")) Russian_Cesar.Encript_Russian(s,key);
            if (language.equalsIgnoreCase("E")) English_Cesar.Encrypt_English(s,key);// Вызываем метод шифрования
            ...
            Scanner sc1 = new Scanner(System.in);
            int key = sc1.nextInt();
            if (language.equalsIgnoreCase("R")) Russian_Cesar.Decript_Russian(s,key);
            if (language.equalsIgnoreCase("E")) English_Cesar.Decrypt_English(s,key);// Вызываем метод дешифрования
        }
    }
}
